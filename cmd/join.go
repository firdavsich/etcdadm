...
func init() {
	...
	joinCmd.PersistentFlags().IntVar(&etcdAdmConfig.PeerPort, "peer-port", constants.DefaultPeerPort, "install directory")
	joinCmd.PersistentFlags().IntVar(&etcdAdmConfig.ClientPort, "client-port", constants.DefaultClientPort, "install directory")
	...
	joinCmd.PersistentFlags().StringVar(&etcdAdmConfig.DataDir, "data-dir", constants.DefaultDataDir, "data directory")
